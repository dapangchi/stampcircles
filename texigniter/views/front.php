...
<body>
    ...
    <div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <div class="fill" style="background-image:url('http://placehold.it/1900x1080&text=Stamp Collecting Articles');"></div>
                <div class="carousel-caption">
                    <h1>Articles for all the World's Countries</h1>
                </div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url('http://placehold.it/1900x1080&text=Postal History Articles ');"></div>
                <div class="carousel-caption">
                    <h1>Read and Write about your Passion</h1>
                </div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url('http://placehold.it/1900x1080&text=Community');"></div>
                <div class="carousel-caption">
                    <h1>Stamps and Postal History Talk, Buy and Sell</a>
                    </h1>
                </div>
            </div>
        </div>
    ...
    <!-- JavaScript -->
    <script src="/modern-business/js/jquery-1.10.2.js"></script>
