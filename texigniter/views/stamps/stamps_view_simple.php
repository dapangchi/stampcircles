...
<!-- START NAVIGATION TOP HIDDEN -->
	...
	<div style="width:100%;background-color:#fff;">
		...
		<div id="nav21" style="height:0px;width:100%;margin-left:0px;padding-right:0;background-color:#ccc;" >
    ...
    <div class="row-fluid" style="padding:8pt 0pt 8pt 0pt;width:100%;background-color:#ccc;">
	     <span class="icon-home">&nbsp; </span><a class="nav-img" data-toggle="tooltip"><span  class="icon-globe" title="All Countries Menu"> </span></a>
         ...
         <div class="btn-group pull-right"  >
                <button class="btn btn-inverse dropdown-toggle btn-small" data-toggle="dropdown">Portals <span class="caret"></span></button>
                    <ul class="dropdown-menu hidden">
                        ...
                        <li><a href="#"><?php echo '<a data-toggle="modal" href="#renameportalModal" class=""><i class="icon-edit"></i> Rename Portal</a>'; ?> </a></li>
            ...
            <div class="btn-group pull-right">
                <button class="btn btn-inverse dropdown-toggle btn-small" data-toggle="dropdown">Document <span class="caret"></span></button>
                    <ul class="dropdown-menu hidden">
                        ...
                        <li><a href="#"><?php echo '<a data-toggle="modal" href="#renameportalModal" class=""><i class="icon-copy"></i> Rename Document </a>'; ?> </a></li>
                        ...
                        <li class="divider"></li>
						<li><a href="#"><?php echo '<a href="'.site_url().'adminSTAMPS/post/edit/'.$portal.'/'.$location.'/main"><i class="icon-edit"></i> Edit Main TeX File </a> ';?> </a></li>
            ...
            <div class="btn-group pull-right">
                <button class="btn btn-inverse dropdown-toggle btn-small" data-toggle="dropdown">Page <span class="caret"></span></button>
                    <ul class="dropdown-menu hidden">
                        <li><a href="#"><?php echo '<a href="'.site_url().'adminSTAMPS/post/edit/'.$portal.'/'.$location.'/'.$title.'"><i class="icon-pencil"></i> Edit Page </a> ';?> </a></li>
                        <li><a href="#"><?php echo '<a href="'.site_url().'adminSTAMPS/post/new/'.$portal.'/'.$location.'/'.$title.'"><i class="icon-plus"></i> New Page </a>'; ?> </a></li>
                        <li><a href="#"><?php echo '<a data-toggle="modal" href="#renamedocModal"><i class = "icon-edit"></i> Rename Page</a>'; ?> </a></li>
                        <li><a href="#"><?php echo '<a href="'.site_url().'adminSTAMPS/post/delete/'.$portal.'/'.$location.'/'.$title.'"><i class="icon-trash" style="color:red"></i> Delete Page </a>'; ?> </a></li>
                            
                        <li><?php echo '<a target="_blank" href="'.site_url().'sandboxPDF/pdflatex/'.$portal.'/'.$location.'/'.$title.'?='.time().'"><i class="icon-book"></i> Texify</a>';
                        ?> </li>
                            <li class="divider"></li>
                            <li><a href="#"><?php echo '<a href="site_url()adminSTAMPS/post/edit/'.$location.'/'.$title.'"><i class="icon-cog"></i> Settings </a> ';?> </a></li>
                        </ul>
            </div><!-- /btn-group -->
    ...
    <!-- END NAVIGATION -->
<!-- splash -->	
<div style="height:350px;text-align:center;background: url(<?php echo site_url(); ?>/stamp-images/beta/<?php echo $splash?>)no-repeat center center; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;">
</div>
...
<div id="men" class="p" role="navigation" style="padding:70px 10px 200px 10px;display:block;float:right;width:22%;" >
	  <!-- <a href="#menu" class="menu-link" style="color:#000;position:relative;top:0px;left:0px;
		z-index:10000;font-weight:bold;padding:5px;margin:-20px">&nbsp; &#9776;  <?php echo $web_name ?>&nbsp; </a> -->
        <?php
			echo $countrymenu; 
...
<div id="clonedocModal" class="modal hide" tabindex="-1"
  ...
  <form id="cloneDocForm" method="post"
         action="<?php echo site_url(); ?>/adminSTAMPS/post/clonedoc/<?php echo$portal.'/'.$location.'/'.$title;?>">
<div class="modal-header">
 <button type="button" class="close" data-dismiss="modal"></button>
