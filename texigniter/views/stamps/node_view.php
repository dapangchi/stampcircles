...
<!-- START NAVIGATION TOP HIDDEN -->
            ...
            <div class="btn-group pull-right">
                <button class="btn btn-inverse dropdown-toggle btn-small" data-toggle="dropdown">Page <span class="caret"></span></button>
                    <ul class="dropdown-menu hidden">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo site_url().'/adminSTAMPS/post/edit/'.$location.'/'.$title; ?>"><i class="icon-cog"></i> Settings </a></li>
                        </ul>
            </div><!-- /btn-group -->
    ...
    <!-- END NAVIGATION -->
<!-- splash -->	
<div style="height:450px;text-align:center;background: url(<?php echo site_url("stamp-images/beta/$splash");?>)no-repeat center center; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;">
</div>
...
<div id="men" class="p" role="navigation" style="padding:70px 10px 200px 10px;display:block;float:right;width:22%;" >
		...
		?>
            ...
            <div class="center" style="margin-top:50px">
				<div class="btn-toolbar pull-right" style="margin-right:25px">
					<div class="btn-group">
                         <a class="btn btn-inverse btn-small" href="<?php echo site_url('adminSTAMPS/post/edit/'.$portal.'/'.$location.'/'.$title.'');?>">edit</a>
					</div>		
				</div>	
            </div>
		</div>
    ...
    <div class="row-fluid" style="margin-top:0px;background:#fff">
            ...
            <p style="font-size:0.7em;line-height:1.3;text-align:center" >
                    ...
                    And download pictures for private usage only! node_view
...
$(document).ready(function(){
    ...
    $('.nav_inner').load('<?php echo site_url(); ?>/js/countries_menu.html'); //<!-- change to jquery menu-->
