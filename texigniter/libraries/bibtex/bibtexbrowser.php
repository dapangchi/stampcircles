...
(C) 2013 Yiannis Lazarides modified as a CodeIgniter Library
...
@define('BIBLIOGRAPHYSTYLE','DefaultBibliographyStyle');// DefaultBibliographyStyle this is the name of a function
...
class StateBasedBibtexParser {
  ...
  function parse($bibfilename) {
    ...
    /* GETVALUEDELIMITEDBYCURLYBRACKETS* handle entries delimited by curly 
     * brackets and the possible nested curly brackets 
     */
