<form method="POST"  action="<?php echo $_SERVER['PHP_SELF']; ?>" style="width:50%;margin:0 auto">
...
$text6="
  ...
  action:form.php;
  method:post;
  controls:text2,radio1,radio2,languageselect,text1, work,number2,comments,submit1,illness,;
}
...
work{
  type:text; 
  names:title,attribute1,attribute2,attribute3;
  values:enabled;
  labels:Tell us the format of your work, Title of work, Attribute work to name,attribute work to URL,More permissions URL;
  status:enabled;
...
public   $properties=array('name','value','checked','disabled','readonly','size','maxlength','src','alt','usemap','ismap','tabindex',
                            'accesskey','onfocus','onblur','onselect','onchange','accept',
...
?>
<br />
<input name="submit" type="submit" value="Process"><br />
</form>
