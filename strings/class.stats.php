...
include('utilities.php');
 ...
 $text=('A.B.C.D. 1901 plus 1902 equals 1902.45'); 
 $z=new TextStatistics;
 $s=$z->flesch_kincaid_reading_ease($text);
 echo $s;
 $s=$z->flesch_kincaid_grade_level('This is something I said to-day');
 $s=$z->gunning_fog_score($text);
 $s=$z->sentence_count($text);
 echoPRE('sentences '.$s);
 $s=$z->smog_index($text);
 echoPRE('smog '.$s);
