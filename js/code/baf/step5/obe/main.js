...
dojo.require("obe.WorkspaceManager");
...
dojo.require("baf.data.WsoDefinitionsManager");
dojo.require("baf.data.DataManager");
...
(function(){
  ...
  obe.main.startup= function(args) {
    ...
    main.wsoDefinitionsManager= new baf.data.WsoDefinitionsManager(args);
    main.dataManager= new baf.data.DataManager(args);
    main.workspaceManager= new obe.WorkspaceManager(args);
    ...
    //appContainer.addChild(main.workspaceManager.widget);
