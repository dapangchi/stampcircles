...
goog.info.range='goog.math.Range ... loaded';
 ...
 */
goog.math.Range.prototype.equals = function(a, b) {
  if (a == b) {
    return true;
  }
  if (!a || !b) {
...
// HAVE CHANGED TO prototype
// probably screwed up the rest of the graphics library
 ...
 */
goog.math.Range.prototype.containsPoint = function(range, p) {
