...
// WINDOW EXAMPLE
    ...
    var window1 = new goog.fx.Dragger(goog.dom.getElement('win1'), goog.dom.getElement('win1').firstChild, limits);
    var window2 = new goog.fx.Dragger(goog.dom.getElement('win2'), goog.dom.getElement('win2').firstChild, limits);
    var window3 = new goog.fx.Dragger(goog.dom.getElement('win3'), goog.dom.getElement('win3').firstChild);
